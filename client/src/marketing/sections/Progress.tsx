        ...
        <div className="mt-8 grid grid-cols-1 items-center gap-8 md:grid-cols-[380px,1fr]">
          ...
          <div className="relative h-[520px] w-[260px] self-center justify-self-center rounded-[36px] bg-black/70 p-4 ring-1 ring-white/10">
            <div className="h-full rounded-2xl bg-gradient-to-b from-white/5 to-white/10 p-4">
              <div className="mb-4 rounded-lg bg-white/5 p-3 text-sm text-white/80">{t('landing:progress.metrics.benchPress')} 225 lbs</div>
              <div className="mb-4 rounded-lg bg-white/5 p-3 text-sm text-white/80">{t('landing:progress.metrics.squat')} 315 lbs</div>
              <div className="mb-4 rounded-lg bg-white/5 p-3 text-sm text-white/80">{t('landing:progress.metrics.deadlift')} 405 lbs</div>
            </div>
          </div>
          <ul className="grid gap-4 text-white/85">
            ...
            <li>• {t('landing:progress.metrics.restDays')}</li>
            <li>• {t('landing:progress.metrics.workoutHistory')}</li>
          </ul>
        </div>
      </div>
    </section>
